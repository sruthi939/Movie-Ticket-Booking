        ...
        <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
            ...
            <div className='flex items-center gap-4 text-gray-300'>
                ...
                <div className='flex items-center gap-1'>
                    <Calendar className='w-4.5 h-4.5' /> 2026
                </div>
                <div className='flex items-center gap-1'>
            ...
            <button onClick={()=> navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bgprimary-dull transition rounded-full font-medium cursor-pointer'>
                Explore More
